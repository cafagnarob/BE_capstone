...
@AllArgsConstructor
@Order(21)
public class PeugeotMotocyclesInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (motorcycleModelRepository.existsByBrandName("Peugeot Motocycles")) {
            return;
        }

        Resource resource =
                new ClassPathResource(
                        "DATA/csv/ModelPeugeotMotocycles.csv"
                );
