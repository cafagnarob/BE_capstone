...
@AllArgsConstructor
@Order(13)
public class HarleyDavidsonInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (motorcycleModelRepository.existsByBrandName("Harley-Davidson")) {
            return;
        }

        Resource resource =
                new ClassPathResource(
                        "DATA/csv/ModelHarleyDavidson.csv"
                );
        ...
        reader.lines()
                ...
                .forEach(line -> {
                    ...
                    if (!data[2].trim().matches("\\d+")) {
                        throw new RuntimeException(
                                "Errore CSV nella riga: " + line
                        );
                    }
